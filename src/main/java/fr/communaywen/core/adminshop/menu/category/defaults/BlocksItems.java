...
public enum BlocksItems implements BaseItems {
    ...
    GRASS_BLOCK(19, 2, ShopType.SELL_BUY, "§7Bloc d'herbe"),
    STONE(20, 2, ShopType.SELL_BUY, "§7Pierre"),
    DIORITE(21, 2, ShopType.SELL, "§7Diorite"),
    DEEPSLATE(22, 2, ShopType.BUY, "§7Ardoise des abîmes"),
    ICE(23, 2, ShopType.BUY, "§7Glace"),
    AMETHYST_BLOCK(24, 2, ShopType.BUY, "§7Bloc d'améthyste"),
    OAK_LEAVES(25, 2, ShopType.SELL, "§7Feuilles de chêne"),
    DIRT(28, 2, ShopType.BUY, "§7Terre"),
    GRAVEL(29, 2, ShopType.SELL, "§7Gravier"),
    GRANITE(30, 2, ShopType.SELL, "§7Granite"),
    OBSIDIAN(31, 2, ShopType.SELL, "§7Obsidienne"),
    PACKED_ICE(32, 2, ShopType.SELL, "§7Glace compactée"),
    MOSS_BLOCK(33, 2, ShopType.SELL, "§7Bloc de mousse"),
    FLOWERING_AZALEA_LEAVES(34, 2, ShopType.SELL, "§7Feuilles d'azalée fleurie"),
