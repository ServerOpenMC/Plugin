...
public class PlayerDetailsMenu extends Menu {
	...
	public @NotNull Map<Integer, ItemStack> getContent() {
		...
		map.put(0, new ItemBuilder(this, CustomStack.getInstance("_iainternal:icon_back_orange")
				.getItemStack(), itemMeta -> itemMeta.setDisplayName(ChatColor.DARK_GREEN + "Retour")).setBackButton());
		...
		map.put(1, new ItemBuilder(this, Material.COMPASS, itemMeta -> {
			...
			itemMeta.setLore(List.of(ChatColor.BLUE + String.valueOf(
		...
		map.put(4, new ItemBuilder(this, ItemUtils.getPlayerSkull(target.getUniqueId()), itemMeta -> {
			...
			itemMeta.setLore(List.of(ChatColor.BLUE + "Team : " + (teamManager.getTeamByPlayer(target.getUniqueId()) == null ?
					ChatColor.ITALIC + "Wilderness" : teamManager.getTeamByPlayer(target.getUniqueId()).getName())));
		}));
