...
/*
    Provient de https://github.com/moby/moby/blob/master/pkg/namesgenerator/names-generator.go
    NE RAJOUTER PAS d'autres noms!!!
*/
...
public class ContainerNameGenerator {
    ...
    public static String getRandomName(int retry) {
        String name;
        do {
            name = LEFT[RANDOM.nextInt(LEFT.length)] + "_" + RIGHT[RANDOM.nextInt(RIGHT.length)];
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getRandomName(1));
    }
}
