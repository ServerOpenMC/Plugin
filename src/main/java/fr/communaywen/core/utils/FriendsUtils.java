...
public class FriendsUtils {
	...
	public static boolean addInDatabase(DatabaseManager dbManager, String firstUUID, String secondUUID) {
		try {
	...
	public static boolean removeInDatabase(DatabaseManager dbManager, String firstUUID, String secondUUID) {
		try {
			Connection connection = dbManager.getConnection();
	...
	public static boolean areFriends(DatabaseManager dbManager, String firstUUID, String secondUUID) {
		try {
			Connection connection = dbManager.getConnection();
	...
	public static Timestamp getTimestamp(DatabaseManager dbManager, String firstUUID, String secondUUID) {
		try {
			Connection connection = dbManager.getConnection();
